...
$sql      = "SELECT * FROM users WHERE panno='$username'";
$result   = mysql_query($sql);
if ($row = mysql_fetch_array($result)) {
  $_SESSION['username'] = $row['panno'];
...
<html>
<head>
  <title><?php echo strtoupper($_SESSION['username']);?> : Date-wise records</title>
...
<div class="returnStatusUpdated" style="display:none">
  <p>Return status updated successfully!</p>
</div>
  <!--start-header-->
      ...
      <div class="head">
        ...
        <div class="navigation">
          ...
          <ul class="navig">
            ...
            <li><a href="adminDatewiseRecords.php" class="active">Datewise Records</a></li>
      ...
      <div class="row">
        <div class="col-md-12 col-md-offset-0">
          <div class="row login-div-margin noBorder">
            <div class="col-md-12">
              <center><h2>Date wise records</h2></center>
              <br>
        <form method="post" id="frmAdminDatewiseRecords">
          <table align="center">
            <tr>
              <td>Pick a date : </td>
              <td>
              ...
              <td>
                <input type="submit" name="showMeDetails" value="Get Details" />
              </td>
            </tr>
          </table>
        </form>
        <br>
 <?php
        if(isset($_POST['showMeDetails']))
        {
          include('dbconfig.php');
          $usersQuery = "SELECT * FROM userdetails where dateofdetails='".$_POST['txtDate']."'";
          $usersResults = mysql_query($usersQuery) or die(mysql_error($con));
          if (mysql_num_rows($usersResults) > 0) {
                echo "<table border=1 class='adminUsersTable'>";
                echo "<tr>
                <th>PAN Number</th>
                <th>First Name</th>
                <th>Last Name</th>   
              ...
              while ($row = mysql_fetch_row($usersResults)) {
                echo "<tr data-pan='" . $row[0] . "'>";
                echo "<td>" . $row[0] . "</td>";
                echo "<td>" . $row[2] . "</td>";
                echo "<td>" . $row[4] . "</td>";
                echo "<td>" . $row[8] . "</td>";
                ...
                if ($row[23] == '') {
                  $tempLink = '#';
                  echo "<td><a href='" . $tempLink . "' class='noUploaded'>form16</a> (Not Uploaded)</td>";
                } else {
                  $tempLink = $row[23];
                  echo "<td><a href='" . $tempLink . "' target='_blank' class='uploaded'>form16</a></td>";
                }
                
                echo "<td><a href='php_userDetails.php?panno=".$row[0]."'  target='_blank' id='".$row[0]."'>View Details</a></td>";

                echo "<td><a href='php_userViewDocuments.php?panno=".$row[0]."'  target='_blank' id='".$row[0]."'>View Documents</a></td>";
                ...
                if ($row[23] == '') {
                  echo "<td><select name='status' id='status' disabled>";
                } else {
        ...
        <div class="footer-text">
          <div class="col-md-6 footer-left">
            <ul>
              ...
              <li><a href="https://twitter.com/mykartax" target="_blank"><span class="t"> </span></a></li>
