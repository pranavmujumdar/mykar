...
session_start();
    ...
    $frmAadharNumber = test_input($_POST['txtAadharNumber']);
    ...
    $userDetailsQuery = "UPDATE userdetails SET aadharno='$frmAadharNumber',
    fname='$frmFirstName',
    mname='$frmMiddleName',
    lname='$frmLastName',
    ...
    if(mysql_affected_rows() > 0){
        ...
        header('Location: userprofileparttwo.php');
        exit;
    }
    else{
