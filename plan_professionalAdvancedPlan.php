...
<head>
  ...
  <script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
      ...
      jQuery("#fileCapitalGain").uploadFile({
       url:"php_uploadCapitalGain.php?pan="+u,
       allowedTypes:"pdf,jpeg,png,jpg",
       fileName:"myfile",
       maxFileSize:5000000
     });
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <div class="row login-div-margin">
                  <div class="col-md-12">
                    <h3>You are selected Professional-Advacned plan you will be charged <strong>INR 450.</strong></h3>
                    <br>
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-9">
                    <div id="fileCapitalGain">Upload</div>
                    <br>
                  </div>
                  <div class="col-md-3">
                    Other Income:
