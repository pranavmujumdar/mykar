      ...
      <div class="head">
        ...
        <div class="navigation">
          ...
          <ul class="navig">
            ...
            <li><a href="adminDatewiseRecords.php">Datewise Records</a></li>
        ...
        <div class="col-md-12 col-md-offset-0">
          <div class="row login-div-margin noBorder">
            <div class="col-md-12">
              ...
              <br>
              <?php
              $usersQuery = "SELECT * FROM userdetails";
              $usersResults = mysql_query($usersQuery) or die("Error in query." . mysql_error());
