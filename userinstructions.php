...
<html>
<head>
<title>Instructions : <?php echo strtoupper($_SESSION['mypanno']);?></title>
      ...
      <div class="head">
        ...
        <div class="navigation">
          ...
          <ul class="navig">
            ...
            <li><a href="userinstructions.php" class="active">Instructions</a></li>
              ...
              <div class="row">
                <div class="col-md-12 col-md-offset-0">
                  <div class="row login-div-margin noBorder">
                    <div class="col-md-12">
                      <center><h2>User instructions</h2></center>
                      <br>
