...
/////////////////////////////////////////////
$form16path     = "SELECT form16path FROM userdetails WHERE panno='$mypanno'";
$form16pathEdit  = mysql_query($form16path);
if ($resultRow = mysql_fetch_array($form16pathEdit)) {
  $formPath16 = $resultRow['form16path'];
}
  ...
  <script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
      ...
      if(errorMessage !== ''){
        ...
        jQuery('.message').html(errorMessage).slideDown('slow').delay(5000).slideUp('slow');
      }
      
      jQuery("#fileForm16Document").uploadFile({
       url:"php_uploadForm16.php?pan="+u,
       allowedTypes:"pdf,jpeg,png,jpg",
       fileName:"myfile",
       maxFileSize:5000000
     });
      
      jQuery("#fileIncomeHouseProperties").uploadFile({
       url:"php_uploadIncomeHouseProperties.php?pan="+u,
       allowedTypes:"pdf,jpeg,png,jpg",
       fileName:"myfile",
       maxFileSize:5000000
     });
      
      jQuery("#fileOtherIncome").uploadFile({
       url:"php_uploadOtherIncome.php?pan="+u,
       allowedTypes:"pdf,jpeg,png,jpg",
       fileName:"myfile",
       maxFileSize:5000000
     });
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <div class="row login-div-margin">
                  <!--div class="col-md-12">
                    <h3>You are selected Basic plan.</h3>
                    <br>
                  </div-->
                  <div class="col-md-12">
                    <h3>Update Form16</h3>
                  ...
                  <div class="col-md-9">
                    <div id="fileForm16Document">Upload Form 16</div>
                    <br>
                  </div>
				    <div class="col-md-9">
					To view the current uploaded form please  <a class="btn btn-primary" href="">Click here</a>   and then
                    <a id="viewForm16" href="<?php echo $formPath16; ?>" class="btn btn-primary" target="_blank"><strong>View Form 16</strong></a></div>
                    <br>
                  </div>
                  <!--div class="col-md-3">
                  ...
                  <div class="col-md-9">
                    <div id="fileIncomeHouseProperties">Upload</div>
                    <br>
                  </div>
                  <div class="col-md-3">
                    Other Income:
                  ...
                  <div class="col-md-9">
                    <div id="fileOtherIncome">Upload</div>
                    <br>
                  </div>
                  <div class="col-md-3">
                    Other Document:
