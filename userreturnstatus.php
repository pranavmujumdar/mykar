...
<html>
<head>
<title>Return status : <?php echo strtoupper($_SESSION['mypanno']);?></title>
      ...
      <div class="head">
        ...
        <div class="navigation">
          ...
          <ul class="navig">
            ...
            <li><a href="userreturnstatus.php" class="active">Return status</a></li>
              ...
              <div class="row">
                <div class="col-md-12 col-md-offset-0">
                  <div class="row login-div-margin noBorder">
                    <div class="col-md-12">
                      <center><h2>Return Status</h2></center>
                      <br>
                      <?php
                  $statusQuery = "SELECT form16path,returnstatus FROM userdetails WHERE panno='" . $_SESSION['mypanno'] . "'";
                  $result      = mysql_query($statusQuery);
                  if ($returnRow = mysql_fetch_array($result)) {
                    if($returnRow['form16path'] == '')
                    {
                      echo "<strong>Your form 16 Return status is : </strong>" . "<span class='notUploadedForm16'>You are not uploaded form yet!</span>";
                    }else
                    {
                      if($returnRow['returnstatus'] == '')
                        echo "<strong>Your form 16 Return status is : </strong>" . "<span class='notUploadedForm16'>We are not reviewed your Form 16 yet!</span>";
                      else
                        echo "<strong>Your form 16 Return status is : </strong>" . $returnRow['returnstatus'];
                    }
                  }
                  ?>
                    </div>
